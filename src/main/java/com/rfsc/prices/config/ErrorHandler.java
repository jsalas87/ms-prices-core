...
import com.rfsc.prices.adapter.rest.exception.EmptyOrNullBodyRestClientException;
import com.rfsc.prices.adapter.rest.exception.NonTargetRestClientException;
import com.rfsc.prices.adapter.rest.exception.NotFoundRestClientException;
import com.rfsc.prices.adapter.rest.exception.RestClientGenericException;
import com.rfsc.prices.adapter.rest.exception.TimeoutRestClientException;
import com.rfsc.prices.adapter.rest.exception.BadRequestRestClientException;
...
public class ErrorHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handle(MissingRequestHeaderException ex) {
        log.error(HttpStatus.BAD_REQUEST.getReasonPhrase(), ex);
        return buildResponseError(HttpStatus.BAD_REQUEST, ex, new ErrorCode(HttpStatus.BAD_REQUEST.value(), ex.getMessage()));
    }
